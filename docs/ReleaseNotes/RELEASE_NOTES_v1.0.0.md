...
### Features
- **Agent core**: multi-turn tool loop with 16 reference-compatible tools (read, edit, grep, shell, web research, trajectory search, etc.)
...
**Artifacts**: `_INFO_OPEN_DESIGN_QUESTIONS.md`, `_INFO_TOOL_DEFINITIONS.md`
