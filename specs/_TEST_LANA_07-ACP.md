...
**Depends on:**
- `_SPEC_LANA_07-ACP.md [LANAACPB-SP01]` rev 2026-08-30 14:00 for requirements
- `_IMPL_LANA_07-ACP.md [LANAACPB-IP01]` rev 2026-08-30 14:05 for the unit/integration test cases (TC-01..43) and phases
- `_INFO_LANAACPB-IN01_AcpV1WireShapeVerification.md [LANAACPB-IN01]` for wire fixtures (authority over the local doc snapshots)
- `_TEST_LANA_01-ProductOverview.md [LANAAGNT-TP01]` for the existing harness contract and layer definitions
