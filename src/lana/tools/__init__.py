...
class ToolContext:
  workspace: Path
  data_dir: Optional[Path] = None     # resolved runtime data directory; falls back to workspace/.agent-data
  tools_dir: Optional[Path] = None    # .agent-tools/ dir for external binaries (rg, fd); resolved from app_dir
