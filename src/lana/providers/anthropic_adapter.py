...
from lana.providers.base import PROVIDER_TIMEOUT, RETRY_DELAYS_SECONDS, AdapterDelta, ProviderError, format_provider_error, is_retryable_error
    ...
    while True:
      ...
      try:
        ...
        if not yielded and attempt < len(RETRY_DELAYS_SECONDS) and is_retryable_error(error):
          ...
          continue
        raise ProviderError(format_provider_error("Anthropic", error)) from None
