...
- QA-07: No markdown tables (use lists unless `<PromptSystem MarkdownTablesAllowed=true />` present)
- QA-08: No emojis (unless `<PromptSystem EmojisAllowed=true />` present)
