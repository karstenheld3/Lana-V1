...
# IG-01: system prompt byte-identical across builds with the REAL DevSystemV4.2 content
def test_ig01_byte_identity_real_system():
  ...
  first_load = build_system_prompt(load_prompt_systems([DEVSYSTEM_PATH]), workspace_info)
  second_load = build_system_prompt(load_prompt_systems([DEVSYSTEM_PATH]), workspace_info)
