...
# Tools dropped from the tool set (DD-10) - must not appear outside <capability_notice> (RV01 RF-04)
...
FR03_SECTION_ORDER = ["You are Lana", "<principles>", "<tools_and_commands>", "<domain_clauses>", "<reply_format>", "<workflows>", "<user_rules>", "<capability_notice>", "<user_information>"]
...
def test_memory_blocks_and_preamble(fake_system):
  ...
  assert "The user's rules, from the user's rules folder. They outrank this prompt." in prompt
