...
TEST_REGISTRY = {
  ...
  "model_id_startswith": [
    ...
    {"prefix": "glm-5.2", "provider": "zai", "method": "reasoning_effort", "max_input": 1000000, "max_output": 16384, "effort": ["none", "minimal", "low", "medium", "high", "xhigh", "max"], "default": "high", "seed": False},
  ],
}
...
TEST_PRICING = {
  "pricing": {
    ...
    "zai": {"glm-5.2": {"input_per_1m": 1.40, "cached_per_1m": 0.26, "output_per_1m": 4.40, "context_window_k": 1000, "currency": "USD"}},
  }
}
...
# Write a complete isolated config folder; returns its path. Overrides patch the agent-config content.
def write_config_dir(base_path, lana_overrides=None, key_lines=("OPENAI_API_KEY=sk-test-openai", "ANTHROPIC_API_KEY=sk-test-anthropic", "ZAI_API_KEY=sk-test-zai")):
  ...
  (config_dir / "agent-config.json").write_text(json.dumps(lana_content, indent=2), encoding="utf-8")
