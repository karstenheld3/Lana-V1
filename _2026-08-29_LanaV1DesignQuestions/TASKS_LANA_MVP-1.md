...
- [ ] Record environment baseline: Python version (3.12+ required), `pip --version`, empty `src/` confirmed, no pre-existing tests (greenfield - baseline is the clean state)
- [ ] Confirm read access to `e:\Dev\IPPS\DevSystemV4.2` and the 4 `config/*.json` inputs
- [ ] Note: API keys NOT required until TK-016/TK-017 (Phase D live smokes); all of A-C and the scripted-adapter path through E-G run key-free
...
- [ ] **LANAAGNT-TK-001** - Package skeleton: pyproject.toml, README.md, entry point, module stubs
...
- [ ] **LANAAGNT-TK-002** - Canonical conversation model
...
- [ ] **LANAAGNT-TK-003** - AgentEvent types and JSONL serialization
...
- [ ] **LANAAGNT-TK-004** - Configuration loading and validation
...
- [ ] **LANAAGNT-TK-005** - PromptSystem loader
...
- [ ] **LANAAGNT-TK-006** - System prompt section constants
...
- [ ] **LANAAGNT-TK-007** - System prompt assembly
  - Files: `src/lana/prompt.py`
...
- [ ] **LANAAGNT-TK-008** - Tool definitions transcription 1/2: file reading + editing (8 tools)
...
- [ ] **LANAAGNT-TK-009** - Tool definitions transcription 2/2: remaining 7 + registry
...
- [ ] **LANAAGNT-TK-010** - File reading tool executors
...
- [ ] **LANAAGNT-TK-011** - Edit tool executors with ReadLedger
...
- [ ] **LANAAGNT-TK-012** - Safety classifier
...
- [ ] **LANAAGNT-TK-013** - Shell tool executors
...
- [ ] **LANAAGNT-TK-014** - State, skill, interaction tool executors
...
- [ ] **LANAAGNT-TK-015** - Adapter protocol and selection
...
- [ ] **LANAAGNT-TK-016** - OpenAI Responses adapter
...
- [ ] **LANAAGNT-TK-017** - Anthropic Messages adapter with caching
...
- [ ] **LANAAGNT-TK-018** - Scripted adapter and turn scripts
...
- [ ] **LANAAGNT-TK-019** - Agent turn loop core
...
- [ ] **LANAAGNT-TK-020** - Loop limits, caps, cancellation
  - Files: `src/lana/agent.py`
...
- [ ] **LANAAGNT-TK-021** - Session store and resume
...
- [ ] **LANAAGNT-TK-022** - Slash command expansion and built-ins
...
- [ ] **LANAAGNT-TK-023** - CLI startup and renderer
...
- [ ] **LANAAGNT-TK-024** - Headless mode and exit codes
...
- [ ] **LANAAGNT-TK-025** - LanaProc test harness
...
- [ ] **LANAAGNT-TK-027** - Compaction: projection, todo extraction, checkpoint
...
- [ ] **LANAAGNT-TK-028** - read_url_content and view_content_chunk
...
- [ ] **LANAAGNT-TK-029** - search_web via websearch role
  - Files: `src/lana/tools/web_tools.py`
...
- [ ] **LANAAGNT-TK-030** - TP01 scenarios 1-5 (conversation + safety)
...
- [ ] **LANAAGNT-TK-031** - TP01 scenarios 6-10 (robustness + real system + diagnostics)
...
- [ ] **LANAAGNT-TK-032** - NFR fixtures and offline end-to-end
...
- [ ] **LANAAGNT-TK-033** - Live smoke suite complete
...
- [ ] **LANAAGNT-TK-034** - Live acceptance run (IP01 TC-47)
...
- [ ] Full suite vs Task 0 baseline (greenfield: all 65 automated cases green, 0 regressions possible by definition - any red = defect)
- [ ] IP01 VC-01..15 and TP01 VC-01..06 checked off
- [ ] Run `/verify` workflow on the implementation against LANAAGNT-IP01
- [ ] `/sync` LANAAGNT-SP01/IP01 if implementation deviated
- [ ] Update PROGRESS.md - mark complete; `/commit`
